...
[MIMIC-III Clinical Database v1.4](https://physionet.org/content/mimiciii/1.4/) — 53,423 hospital admissions with timestamped vital signs, lab results, medications, and clinical notes. Sepsis cohort extracted using Sepsis-3 criteria (Singer et al., JAMA 2016): suspected infection + SOFA >= 2, yielding 22,505 cases.
